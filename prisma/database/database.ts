...
const prismaClientSingleton= ()=>{ 
  ...
  return prisma.$extends({
    ...
    model: {
      $allModels:{
        convertRawJson<T, A extends Prisma.Args<T, 'create'>>(
          this: T,
          rawJson: JsonObject,
          ...
          for(let [key, value] of Object.entries(obj)){
            ...
            else if(isObject(value)) (ctx as any).convertRawJson(value);
          }
        ...
        polish<T>(
          ...
          let schemaReference = prismaDmmf.datamodel.models.find(m=>m.name===schemaName) || prismaDmmf.datamodel.types.find(t=>t.name===schemaName);
...
*/
type ExtendedClient = ReturnType<typeof prismaClientSingleton>;

declare global {
  var prismaGlobal: ExtendedClient | undefined;
}

export const database: ExtendedClient =
