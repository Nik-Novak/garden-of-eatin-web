...
export default async function preloadDatabase(){
  ...
  const meals:Prisma.MealCreateInput[] = [
    // {
    //   approved: true,
    //   name: "Freda's Free Tacos",
    //   place:{
    //     address: '1359 Garnet ave, San Diego, CA 92109',
    //     location: { type:'Point', coordinates:[-117.2476696, 32.7987004] },
    //   },
    //   location: { type:'Point', coordinates:[-117.24487760052806, 32.79847984554442] },
    ...
    {
      approved: true,
      name: "God's Kitchen - Thursday Beach Brunch",
      place:{
    ...
    {
      approved: true,
      name: "Friday Boardwalk Dinner",
      place:{
        address: '4449 Ocean Blvd, San Diego, CA 92109',
        location: { type:'Point', coordinates:[-117.2566701, 32.795264] },
      },
      location: { type:'Point', coordinates:[-117.256455, 32.795318] },
      timezone: 'America/Los_Angeles',
      schedule: {
        type: 'Weekly',
        every: 1,
        start_date: '2026-02-27T00:00:00.000+00:00',
        reference_dates: [],
        times: [
          {
            start_anchor: 'Sunset',
            start: 0,  //at sunset
            end_anchor: 'Sunset',
            end: 1_800_000  //30 min after sunset
          }
        ],
        recurrence_rules: [
          {
