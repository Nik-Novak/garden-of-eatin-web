...
export const AgreementAggregateSchema: z.ZodType<Prisma.AgreementAggregateArgs> = z.object({ orderBy: z.union([AgreementOrderByWithRelationInputObjectSchema, AgreementOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgreementWhereInputObjectSchema.optional(), cursor: AgreementWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), _count: z.union([ z.literal(true), AgreementCountAggregateInputObjectSchema ]).optional(), _min: AgreementMinAggregateInputObjectSchema.optional(), _max: AgreementMaxAggregateInputObjectSchema.optional() }).strict() as unknown as z.ZodType<Prisma.AgreementAggregateArgs>;

export const AgreementAggregateZodSchema = z.object({ orderBy: z.union([AgreementOrderByWithRelationInputObjectSchema, AgreementOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgreementWhereInputObjectSchema.optional(), cursor: AgreementWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), _count: z.union([ z.literal(true), AgreementCountAggregateInputObjectSchema ]).optional(), _min: AgreementMinAggregateInputObjectSchema.optional(), _max: AgreementMaxAggregateInputObjectSchema.optional() }).strict();