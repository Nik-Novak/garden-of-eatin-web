...
export const ResourceInteractionDeleteOneSchema: z.ZodType<Prisma.ResourceInteractionDeleteArgs> = z.object({ select: ResourceInteractionSelectObjectSchema.optional(), include: ResourceInteractionIncludeObjectSchema.optional(), where: ResourceInteractionWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.ResourceInteractionDeleteArgs>;

export const ResourceInteractionDeleteOneZodSchema = z.object({ select: ResourceInteractionSelectObjectSchema.optional(), include: ResourceInteractionIncludeObjectSchema.optional(), where: ResourceInteractionWhereUniqueInputObjectSchema }).strict();