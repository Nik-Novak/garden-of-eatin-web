...
export const ResourceScalarFieldEnumSchema = z.enum(['id', 'name', 'timezone', 'resource_type', 'selection_type', 'packaging_type', 'loading_policy', 'vehicle_types', 'features', 'dietary_tags', 'categories', 'max_height_clearance_m', 'total_weight_kg', 'max_weight_per_visit_kg', 'min_weight_per_visit_kg', 'typical_volume_m3', 'typical_weight_kg', 'is_bulk', 'appointment_required', 'documentation_required', 'id_required', 'rules', 'approved', 'rejection_reason', 'submitter_id', 'submitter_name', 'created_at', 'updated_at'])
