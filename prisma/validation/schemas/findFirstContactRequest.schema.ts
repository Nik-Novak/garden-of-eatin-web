...
export const ContactRequestFindFirstSelectSchema: z.ZodType<Prisma.ContactRequestSelect> = z.object({
...
export const ContactRequestFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    phone: z.boolean().optional(),
    email: z.boolean().optional(),
...
export const ContactRequestFindFirstSchema: z.ZodType<Prisma.ContactRequestFindFirstArgs> = z.object({ select: ContactRequestFindFirstSelectSchema.optional(), include: z.lazy(() => ContactRequestIncludeObjectSchema.optional()), orderBy: z.union([ContactRequestOrderByWithRelationInputObjectSchema, ContactRequestOrderByWithRelationInputObjectSchema.array()]).optional(), where: ContactRequestWhereInputObjectSchema.optional(), cursor: ContactRequestWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ContactRequestScalarFieldEnumSchema, ContactRequestScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ContactRequestFindFirstArgs>;

export const ContactRequestFindFirstZodSchema = z.object({ select: ContactRequestFindFirstSelectSchema.optional(), include: z.lazy(() => ContactRequestIncludeObjectSchema.optional()), orderBy: z.union([ContactRequestOrderByWithRelationInputObjectSchema, ContactRequestOrderByWithRelationInputObjectSchema.array()]).optional(), where: ContactRequestWhereInputObjectSchema.optional(), cursor: ContactRequestWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ContactRequestScalarFieldEnumSchema, ContactRequestScalarFieldEnumSchema.array()]).optional() }).strict();