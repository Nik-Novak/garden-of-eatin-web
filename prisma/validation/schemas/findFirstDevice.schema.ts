...
export const DeviceFindFirstSchema: z.ZodType<Prisma.DeviceFindFirstArgs> = z.object({ select: DeviceFindFirstSelectSchema.optional(), include: z.lazy(() => DeviceIncludeObjectSchema.optional()), orderBy: z.union([DeviceOrderByWithRelationInputObjectSchema, DeviceOrderByWithRelationInputObjectSchema.array()]).optional(), where: DeviceWhereInputObjectSchema.optional(), cursor: DeviceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DeviceScalarFieldEnumSchema, DeviceScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.DeviceFindFirstArgs>;

export const DeviceFindFirstZodSchema = z.object({ select: DeviceFindFirstSelectSchema.optional(), include: z.lazy(() => DeviceIncludeObjectSchema.optional()), orderBy: z.union([DeviceOrderByWithRelationInputObjectSchema, DeviceOrderByWithRelationInputObjectSchema.array()]).optional(), where: DeviceWhereInputObjectSchema.optional(), cursor: DeviceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DeviceScalarFieldEnumSchema, DeviceScalarFieldEnumSchema.array()]).optional() }).strict();