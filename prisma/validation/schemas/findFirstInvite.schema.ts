...
export const InviteFindFirstSelectSchema: z.ZodType<Prisma.InviteSelect> = z.object({
...
export const InviteFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    email: z.boolean().optional(),
    status: z.boolean().optional(),
    inviter: z.boolean().optional(),
...
export const InviteFindFirstSchema: z.ZodType<Prisma.InviteFindFirstArgs> = z.object({ select: InviteFindFirstSelectSchema.optional(), include: z.lazy(() => InviteIncludeObjectSchema.optional()), orderBy: z.union([InviteOrderByWithRelationInputObjectSchema, InviteOrderByWithRelationInputObjectSchema.array()]).optional(), where: InviteWhereInputObjectSchema.optional(), cursor: InviteWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([InviteScalarFieldEnumSchema, InviteScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.InviteFindFirstArgs>;

export const InviteFindFirstZodSchema = z.object({ select: InviteFindFirstSelectSchema.optional(), include: z.lazy(() => InviteIncludeObjectSchema.optional()), orderBy: z.union([InviteOrderByWithRelationInputObjectSchema, InviteOrderByWithRelationInputObjectSchema.array()]).optional(), where: InviteWhereInputObjectSchema.optional(), cursor: InviteWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([InviteScalarFieldEnumSchema, InviteScalarFieldEnumSchema.array()]).optional() }).strict();