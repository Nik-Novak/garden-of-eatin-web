...
export const MealInteractionFindFirstSelectSchema: z.ZodType<Prisma.MealInteractionSelect> = z.object({
...
export const MealInteractionFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    interaction_type: z.boolean().optional(),
    meal: z.boolean().optional(),
    meal_id: z.boolean().optional(),
...
export const MealInteractionFindFirstSchema: z.ZodType<Prisma.MealInteractionFindFirstArgs> = z.object({ select: MealInteractionFindFirstSelectSchema.optional(), include: z.lazy(() => MealInteractionIncludeObjectSchema.optional()), orderBy: z.union([MealInteractionOrderByWithRelationInputObjectSchema, MealInteractionOrderByWithRelationInputObjectSchema.array()]).optional(), where: MealInteractionWhereInputObjectSchema.optional(), cursor: MealInteractionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MealInteractionScalarFieldEnumSchema, MealInteractionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.MealInteractionFindFirstArgs>;

export const MealInteractionFindFirstZodSchema = z.object({ select: MealInteractionFindFirstSelectSchema.optional(), include: z.lazy(() => MealInteractionIncludeObjectSchema.optional()), orderBy: z.union([MealInteractionOrderByWithRelationInputObjectSchema, MealInteractionOrderByWithRelationInputObjectSchema.array()]).optional(), where: MealInteractionWhereInputObjectSchema.optional(), cursor: MealInteractionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MealInteractionScalarFieldEnumSchema, MealInteractionScalarFieldEnumSchema.array()]).optional() }).strict();