...
export const DeviceFindFirstOrThrowSelectSchema: z.ZodType<Prisma.DeviceSelect> = z.object({
    ...
    submitted_resources: z.boolean().optional(),
    resource_occurrence_searches: z.boolean().optional(),
...
export const DeviceFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    uuid: z.boolean().optional(),
    web_devices: z.boolean().optional(),
    metadata: z.boolean().optional(),
...
export const DeviceFindFirstOrThrowSchema: z.ZodType<Prisma.DeviceFindFirstOrThrowArgs> = z.object({ select: DeviceFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => DeviceIncludeObjectSchema.optional()), orderBy: z.union([DeviceOrderByWithRelationInputObjectSchema, DeviceOrderByWithRelationInputObjectSchema.array()]).optional(), where: DeviceWhereInputObjectSchema.optional(), cursor: DeviceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DeviceScalarFieldEnumSchema, DeviceScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.DeviceFindFirstOrThrowArgs>;

export const DeviceFindFirstOrThrowZodSchema = z.object({ select: DeviceFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => DeviceIncludeObjectSchema.optional()), orderBy: z.union([DeviceOrderByWithRelationInputObjectSchema, DeviceOrderByWithRelationInputObjectSchema.array()]).optional(), where: DeviceWhereInputObjectSchema.optional(), cursor: DeviceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DeviceScalarFieldEnumSchema, DeviceScalarFieldEnumSchema.array()]).optional() }).strict();