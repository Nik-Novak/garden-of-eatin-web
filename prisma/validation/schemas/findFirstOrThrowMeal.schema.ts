...
export const MealFindFirstOrThrowSelectSchema: z.ZodType<Prisma.MealSelect> = z.object({
    ...
    meal_search_hits: z.boolean().optional(),
    meal_interactions: z.boolean().optional(),
    scannable_document_meal_hits: z.boolean().optional(),
...
export const MealFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    place: z.boolean().optional(),
    location: z.boolean().optional(),
...
export const MealFindFirstOrThrowSchema: z.ZodType<Prisma.MealFindFirstOrThrowArgs> = z.object({ select: MealFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => MealIncludeObjectSchema.optional()), orderBy: z.union([MealOrderByWithRelationInputObjectSchema, MealOrderByWithRelationInputObjectSchema.array()]).optional(), where: MealWhereInputObjectSchema.optional(), cursor: MealWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MealScalarFieldEnumSchema, MealScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.MealFindFirstOrThrowArgs>;

export const MealFindFirstOrThrowZodSchema = z.object({ select: MealFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => MealIncludeObjectSchema.optional()), orderBy: z.union([MealOrderByWithRelationInputObjectSchema, MealOrderByWithRelationInputObjectSchema.array()]).optional(), where: MealWhereInputObjectSchema.optional(), cursor: MealWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MealScalarFieldEnumSchema, MealScalarFieldEnumSchema.array()]).optional() }).strict();