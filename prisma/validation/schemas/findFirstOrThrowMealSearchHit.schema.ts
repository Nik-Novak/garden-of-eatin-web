...
export const MealSearchHitFindFirstOrThrowSelectSchema: z.ZodType<Prisma.MealSearchHitSelect> = z.object({
...
export const MealSearchHitFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    meal: z.boolean().optional(),
    meal_id: z.boolean().optional(),
    search: z.boolean().optional(),
...
export const MealSearchHitFindFirstOrThrowSchema: z.ZodType<Prisma.MealSearchHitFindFirstOrThrowArgs> = z.object({ select: MealSearchHitFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => MealSearchHitIncludeObjectSchema.optional()), orderBy: z.union([MealSearchHitOrderByWithRelationInputObjectSchema, MealSearchHitOrderByWithRelationInputObjectSchema.array()]).optional(), where: MealSearchHitWhereInputObjectSchema.optional(), cursor: MealSearchHitWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MealSearchHitScalarFieldEnumSchema, MealSearchHitScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.MealSearchHitFindFirstOrThrowArgs>;

export const MealSearchHitFindFirstOrThrowZodSchema = z.object({ select: MealSearchHitFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => MealSearchHitIncludeObjectSchema.optional()), orderBy: z.union([MealSearchHitOrderByWithRelationInputObjectSchema, MealSearchHitOrderByWithRelationInputObjectSchema.array()]).optional(), where: MealSearchHitWhereInputObjectSchema.optional(), cursor: MealSearchHitWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MealSearchHitScalarFieldEnumSchema, MealSearchHitScalarFieldEnumSchema.array()]).optional() }).strict();