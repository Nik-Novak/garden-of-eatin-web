...
export const NoticeFindFirstOrThrowSelectSchema: z.ZodType<Prisma.NoticeSelect> = z.object({
...
export const NoticeFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    level: z.boolean().optional(),
    content_md: z.boolean().optional(),
    created_at: z.boolean().optional(),
...
export const NoticeFindFirstOrThrowSchema: z.ZodType<Prisma.NoticeFindFirstOrThrowArgs> = z.object({ select: NoticeFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([NoticeOrderByWithRelationInputObjectSchema, NoticeOrderByWithRelationInputObjectSchema.array()]).optional(), where: NoticeWhereInputObjectSchema.optional(), cursor: NoticeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([NoticeScalarFieldEnumSchema, NoticeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.NoticeFindFirstOrThrowArgs>;

export const NoticeFindFirstOrThrowZodSchema = z.object({ select: NoticeFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([NoticeOrderByWithRelationInputObjectSchema, NoticeOrderByWithRelationInputObjectSchema.array()]).optional(), where: NoticeWhereInputObjectSchema.optional(), cursor: NoticeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([NoticeScalarFieldEnumSchema, NoticeScalarFieldEnumSchema.array()]).optional() }).strict();