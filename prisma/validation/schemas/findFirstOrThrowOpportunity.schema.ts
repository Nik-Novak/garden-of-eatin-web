...
export const OpportunityFindFirstOrThrowSelectSchema: z.ZodType<Prisma.OpportunitySelect> = z.object({
...
export const OpportunityFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    title: z.boolean().optional(),
    abstract: z.boolean().optional(),
    description: z.boolean().optional(),
...
export const OpportunityFindFirstOrThrowSchema: z.ZodType<Prisma.OpportunityFindFirstOrThrowArgs> = z.object({ select: OpportunityFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => OpportunityIncludeObjectSchema.optional()), orderBy: z.union([OpportunityOrderByWithRelationInputObjectSchema, OpportunityOrderByWithRelationInputObjectSchema.array()]).optional(), where: OpportunityWhereInputObjectSchema.optional(), cursor: OpportunityWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([OpportunityScalarFieldEnumSchema, OpportunityScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.OpportunityFindFirstOrThrowArgs>;

export const OpportunityFindFirstOrThrowZodSchema = z.object({ select: OpportunityFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => OpportunityIncludeObjectSchema.optional()), orderBy: z.union([OpportunityOrderByWithRelationInputObjectSchema, OpportunityOrderByWithRelationInputObjectSchema.array()]).optional(), where: OpportunityWhereInputObjectSchema.optional(), cursor: OpportunityWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([OpportunityScalarFieldEnumSchema, OpportunityScalarFieldEnumSchema.array()]).optional() }).strict();