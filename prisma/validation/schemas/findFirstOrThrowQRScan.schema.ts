...
export const QRScanFindFirstOrThrowSelectSchema: z.ZodType<Prisma.QRScanSelect> = z.object({
...
export const QRScanFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    qr_code: z.boolean().optional(),
    qr_code_id: z.boolean().optional(),
    qr_action: z.boolean().optional(),
...
export const QRScanFindFirstOrThrowSchema: z.ZodType<Prisma.QRScanFindFirstOrThrowArgs> = z.object({ select: QRScanFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => QRScanIncludeObjectSchema.optional()), orderBy: z.union([QRScanOrderByWithRelationInputObjectSchema, QRScanOrderByWithRelationInputObjectSchema.array()]).optional(), where: QRScanWhereInputObjectSchema.optional(), cursor: QRScanWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([QRScanScalarFieldEnumSchema, QRScanScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.QRScanFindFirstOrThrowArgs>;

export const QRScanFindFirstOrThrowZodSchema = z.object({ select: QRScanFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => QRScanIncludeObjectSchema.optional()), orderBy: z.union([QRScanOrderByWithRelationInputObjectSchema, QRScanOrderByWithRelationInputObjectSchema.array()]).optional(), where: QRScanWhereInputObjectSchema.optional(), cursor: QRScanWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([QRScanScalarFieldEnumSchema, QRScanScalarFieldEnumSchema.array()]).optional() }).strict();