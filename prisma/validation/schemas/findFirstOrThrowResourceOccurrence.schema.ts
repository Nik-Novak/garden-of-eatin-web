...
export const ResourceOccurrenceFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ResourceOccurrenceSelect> = z.object({
...
export const ResourceOccurrenceFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    resource: z.boolean().optional(),
    resource_id: z.boolean().optional(),
    start: z.boolean().optional(),
