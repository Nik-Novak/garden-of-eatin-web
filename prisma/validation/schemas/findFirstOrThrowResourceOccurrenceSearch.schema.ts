...
export const ResourceOccurrenceSearchFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ResourceOccurrenceSearchSelect> = z.object({
...
export const ResourceOccurrenceSearchFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    search_type: z.boolean().optional(),
    hits: z.boolean().optional(),
    start: z.boolean().optional(),
...
export const ResourceOccurrenceSearchFindFirstOrThrowSchema: z.ZodType<Prisma.ResourceOccurrenceSearchFindFirstOrThrowArgs> = z.object({ select: ResourceOccurrenceSearchFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ResourceOccurrenceSearchIncludeObjectSchema.optional()), orderBy: z.union([ResourceOccurrenceSearchOrderByWithRelationInputObjectSchema, ResourceOccurrenceSearchOrderByWithRelationInputObjectSchema.array()]).optional(), where: ResourceOccurrenceSearchWhereInputObjectSchema.optional(), cursor: ResourceOccurrenceSearchWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ResourceOccurrenceSearchScalarFieldEnumSchema, ResourceOccurrenceSearchScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ResourceOccurrenceSearchFindFirstOrThrowArgs>;

export const ResourceOccurrenceSearchFindFirstOrThrowZodSchema = z.object({ select: ResourceOccurrenceSearchFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ResourceOccurrenceSearchIncludeObjectSchema.optional()), orderBy: z.union([ResourceOccurrenceSearchOrderByWithRelationInputObjectSchema, ResourceOccurrenceSearchOrderByWithRelationInputObjectSchema.array()]).optional(), where: ResourceOccurrenceSearchWhereInputObjectSchema.optional(), cursor: ResourceOccurrenceSearchWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ResourceOccurrenceSearchScalarFieldEnumSchema, ResourceOccurrenceSearchScalarFieldEnumSchema.array()]).optional() }).strict();