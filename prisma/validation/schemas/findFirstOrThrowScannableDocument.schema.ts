...
export const ScannableDocumentFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ScannableDocumentSelect> = z.object({
...
export const ScannableDocumentFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    type: z.boolean().optional(),
    name: z.boolean().optional(),
    place: z.boolean().optional(),
