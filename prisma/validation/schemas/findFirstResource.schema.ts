...
export const ResourceFindFirstSelectSchema: z.ZodType<Prisma.ResourceSelect> = z.object({
...
export const ResourceFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    place: z.boolean().optional(),
    location: z.boolean().optional(),
...
export const ResourceFindFirstSchema: z.ZodType<Prisma.ResourceFindFirstArgs> = z.object({ select: ResourceFindFirstSelectSchema.optional(), include: z.lazy(() => ResourceIncludeObjectSchema.optional()), orderBy: z.union([ResourceOrderByWithRelationInputObjectSchema, ResourceOrderByWithRelationInputObjectSchema.array()]).optional(), where: ResourceWhereInputObjectSchema.optional(), cursor: ResourceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ResourceScalarFieldEnumSchema, ResourceScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ResourceFindFirstArgs>;

export const ResourceFindFirstZodSchema = z.object({ select: ResourceFindFirstSelectSchema.optional(), include: z.lazy(() => ResourceIncludeObjectSchema.optional()), orderBy: z.union([ResourceOrderByWithRelationInputObjectSchema, ResourceOrderByWithRelationInputObjectSchema.array()]).optional(), where: ResourceWhereInputObjectSchema.optional(), cursor: ResourceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ResourceScalarFieldEnumSchema, ResourceScalarFieldEnumSchema.array()]).optional() }).strict();