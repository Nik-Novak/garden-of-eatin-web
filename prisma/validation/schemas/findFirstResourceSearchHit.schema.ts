...
export const ResourceSearchHitFindFirstSelectSchema: z.ZodType<Prisma.ResourceSearchHitSelect> = z.object({
...
export const ResourceSearchHitFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    resource: z.boolean().optional(),
    resource_id: z.boolean().optional(),
    search: z.boolean().optional(),
...
export const ResourceSearchHitFindFirstSchema: z.ZodType<Prisma.ResourceSearchHitFindFirstArgs> = z.object({ select: ResourceSearchHitFindFirstSelectSchema.optional(), include: z.lazy(() => ResourceSearchHitIncludeObjectSchema.optional()), orderBy: z.union([ResourceSearchHitOrderByWithRelationInputObjectSchema, ResourceSearchHitOrderByWithRelationInputObjectSchema.array()]).optional(), where: ResourceSearchHitWhereInputObjectSchema.optional(), cursor: ResourceSearchHitWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ResourceSearchHitScalarFieldEnumSchema, ResourceSearchHitScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ResourceSearchHitFindFirstArgs>;

export const ResourceSearchHitFindFirstZodSchema = z.object({ select: ResourceSearchHitFindFirstSelectSchema.optional(), include: z.lazy(() => ResourceSearchHitIncludeObjectSchema.optional()), orderBy: z.union([ResourceSearchHitOrderByWithRelationInputObjectSchema, ResourceSearchHitOrderByWithRelationInputObjectSchema.array()]).optional(), where: ResourceSearchHitWhereInputObjectSchema.optional(), cursor: ResourceSearchHitWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ResourceSearchHitScalarFieldEnumSchema, ResourceSearchHitScalarFieldEnumSchema.array()]).optional() }).strict();