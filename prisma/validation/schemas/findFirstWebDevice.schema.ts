...
export const WebDeviceFindFirstSelectSchema: z.ZodType<Prisma.WebDeviceSelect> = z.object({
...
export const WebDeviceFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    uuid: z.boolean().optional(),
    device: z.boolean().optional(),
    device_id: z.boolean().optional(),
