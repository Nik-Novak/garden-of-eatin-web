...
export const ContributorFindManySelectSchema: z.ZodType<Prisma.ContributorSelect> = z.object({
...
export const ContributorFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    firstName: z.boolean().optional(),
    defaultImage: z.boolean().optional(),
    hoverImage: z.boolean().optional(),
...
export const ContributorFindManySchema: z.ZodType<Prisma.ContributorFindManyArgs> = z.object({ select: ContributorFindManySelectSchema.optional(),  orderBy: z.union([ContributorOrderByWithRelationInputObjectSchema, ContributorOrderByWithRelationInputObjectSchema.array()]).optional(), where: ContributorWhereInputObjectSchema.optional(), cursor: ContributorWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ContributorScalarFieldEnumSchema, ContributorScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ContributorFindManyArgs>;

export const ContributorFindManyZodSchema = z.object({ select: ContributorFindManySelectSchema.optional(),  orderBy: z.union([ContributorOrderByWithRelationInputObjectSchema, ContributorOrderByWithRelationInputObjectSchema.array()]).optional(), where: ContributorWhereInputObjectSchema.optional(), cursor: ContributorWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ContributorScalarFieldEnumSchema, ContributorScalarFieldEnumSchema.array()]).optional() }).strict();