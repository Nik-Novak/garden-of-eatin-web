...
export const DeviceAgreementFindManySelectSchema: z.ZodType<Prisma.DeviceAgreementSelect> = z.object({
...
export const DeviceAgreementFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    device: z.boolean().optional(),
    device_id: z.boolean().optional(),
    agreement: z.boolean().optional(),
...
export const DeviceAgreementFindManySchema: z.ZodType<Prisma.DeviceAgreementFindManyArgs> = z.object({ select: DeviceAgreementFindManySelectSchema.optional(), include: z.lazy(() => DeviceAgreementIncludeObjectSchema.optional()), orderBy: z.union([DeviceAgreementOrderByWithRelationInputObjectSchema, DeviceAgreementOrderByWithRelationInputObjectSchema.array()]).optional(), where: DeviceAgreementWhereInputObjectSchema.optional(), cursor: DeviceAgreementWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DeviceAgreementScalarFieldEnumSchema, DeviceAgreementScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.DeviceAgreementFindManyArgs>;

export const DeviceAgreementFindManyZodSchema = z.object({ select: DeviceAgreementFindManySelectSchema.optional(), include: z.lazy(() => DeviceAgreementIncludeObjectSchema.optional()), orderBy: z.union([DeviceAgreementOrderByWithRelationInputObjectSchema, DeviceAgreementOrderByWithRelationInputObjectSchema.array()]).optional(), where: DeviceAgreementWhereInputObjectSchema.optional(), cursor: DeviceAgreementWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DeviceAgreementScalarFieldEnumSchema, DeviceAgreementScalarFieldEnumSchema.array()]).optional() }).strict();