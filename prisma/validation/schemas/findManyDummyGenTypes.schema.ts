...
export const DummyGenTypesFindManySelectSchema: z.ZodType<Prisma.DummyGenTypesSelect> = z.object({
    id: z.boolean().optional(),
    qrarp: z.boolean().optional()
  }).strict() as unknown as z.ZodType<Prisma.DummyGenTypesSelect>;

export const DummyGenTypesFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    qrarp: z.boolean().optional()
  }).strict();

export const DummyGenTypesFindManySchema: z.ZodType<Prisma.DummyGenTypesFindManyArgs> = z.object({ select: DummyGenTypesFindManySelectSchema.optional(),  orderBy: z.union([DummyGenTypesOrderByWithRelationInputObjectSchema, DummyGenTypesOrderByWithRelationInputObjectSchema.array()]).optional(), where: DummyGenTypesWhereInputObjectSchema.optional(), cursor: DummyGenTypesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DummyGenTypesScalarFieldEnumSchema, DummyGenTypesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.DummyGenTypesFindManyArgs>;

export const DummyGenTypesFindManyZodSchema = z.object({ select: DummyGenTypesFindManySelectSchema.optional(),  orderBy: z.union([DummyGenTypesOrderByWithRelationInputObjectSchema, DummyGenTypesOrderByWithRelationInputObjectSchema.array()]).optional(), where: DummyGenTypesWhereInputObjectSchema.optional(), cursor: DummyGenTypesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DummyGenTypesScalarFieldEnumSchema, DummyGenTypesScalarFieldEnumSchema.array()]).optional() }).strict();