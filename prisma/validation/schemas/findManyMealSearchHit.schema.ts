...
export const MealSearchHitFindManySelectSchema: z.ZodType<Prisma.MealSearchHitSelect> = z.object({
...
export const MealSearchHitFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    meal: z.boolean().optional(),
    meal_id: z.boolean().optional(),
    search: z.boolean().optional(),
