...
export const OpportunityFindManySelectSchema: z.ZodType<Prisma.OpportunitySelect> = z.object({
...
export const OpportunityFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    title: z.boolean().optional(),
    abstract: z.boolean().optional(),
    description: z.boolean().optional(),
