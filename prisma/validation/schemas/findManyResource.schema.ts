...
export const ResourceFindManySelectSchema: z.ZodType<Prisma.ResourceSelect> = z.object({
...
export const ResourceFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    place: z.boolean().optional(),
    location: z.boolean().optional(),
...
export const ResourceFindManySchema: z.ZodType<Prisma.ResourceFindManyArgs> = z.object({ select: ResourceFindManySelectSchema.optional(), include: z.lazy(() => ResourceIncludeObjectSchema.optional()), orderBy: z.union([ResourceOrderByWithRelationInputObjectSchema, ResourceOrderByWithRelationInputObjectSchema.array()]).optional(), where: ResourceWhereInputObjectSchema.optional(), cursor: ResourceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ResourceScalarFieldEnumSchema, ResourceScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ResourceFindManyArgs>;

export const ResourceFindManyZodSchema = z.object({ select: ResourceFindManySelectSchema.optional(), include: z.lazy(() => ResourceIncludeObjectSchema.optional()), orderBy: z.union([ResourceOrderByWithRelationInputObjectSchema, ResourceOrderByWithRelationInputObjectSchema.array()]).optional(), where: ResourceWhereInputObjectSchema.optional(), cursor: ResourceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ResourceScalarFieldEnumSchema, ResourceScalarFieldEnumSchema.array()]).optional() }).strict();