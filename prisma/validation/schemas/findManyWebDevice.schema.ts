...
export const WebDeviceFindManySelectSchema: z.ZodType<Prisma.WebDeviceSelect> = z.object({
...
export const WebDeviceFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    uuid: z.boolean().optional(),
    device: z.boolean().optional(),
    device_id: z.boolean().optional(),
