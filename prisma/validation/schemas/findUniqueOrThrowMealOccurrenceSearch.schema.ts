...
export const MealOccurrenceSearchFindUniqueOrThrowSchema: z.ZodType<Prisma.MealOccurrenceSearchFindUniqueOrThrowArgs> = z.object({ select: MealOccurrenceSearchSelectObjectSchema.optional(), include: MealOccurrenceSearchIncludeObjectSchema.optional(), where: MealOccurrenceSearchWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.MealOccurrenceSearchFindUniqueOrThrowArgs>;

export const MealOccurrenceSearchFindUniqueOrThrowZodSchema = z.object({ select: MealOccurrenceSearchSelectObjectSchema.optional(), include: MealOccurrenceSearchIncludeObjectSchema.optional(), where: MealOccurrenceSearchWhereUniqueInputObjectSchema }).strict();