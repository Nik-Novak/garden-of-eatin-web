...
export const DeviceCountOutputTypeCountMealOccurrenceSearchesArgsObjectSchema = makeSchema();
export const DeviceCountOutputTypeCountMealOccurrenceSearchesArgsObjectZodSchema = makeSchema();
