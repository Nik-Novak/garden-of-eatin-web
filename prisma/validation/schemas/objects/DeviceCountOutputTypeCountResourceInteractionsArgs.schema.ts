...
export const DeviceCountOutputTypeCountResourceInteractionsArgsObjectSchema = makeSchema();
export const DeviceCountOutputTypeCountResourceInteractionsArgsObjectZodSchema = makeSchema();
