...
export const MealCountOutputTypeCountMealSearchHitsArgsObjectSchema = makeSchema();
export const MealCountOutputTypeCountMealSearchHitsArgsObjectZodSchema = makeSchema();
