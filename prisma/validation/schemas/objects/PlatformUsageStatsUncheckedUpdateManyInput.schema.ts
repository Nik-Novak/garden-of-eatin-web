...
const makeSchema = () => z.object({
  total_meals: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputObjectSchema)]).optional(),
  ...
  total_meal_shares: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputObjectSchema)]).optional(),
  created_at: z.union([z.coerce.date(), z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)]).optional(),
  updated_at: z.union([z.coerce.date(), z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)]).optional()
}).strict();
export const PlatformUsageStatsUncheckedUpdateManyInputObjectSchema: z.ZodType<Prisma.PlatformUsageStatsUncheckedUpdateManyInput> = makeSchema() as unknown as z.ZodType<Prisma.PlatformUsageStatsUncheckedUpdateManyInput>;
export const PlatformUsageStatsUncheckedUpdateManyInputObjectZodSchema = makeSchema();
