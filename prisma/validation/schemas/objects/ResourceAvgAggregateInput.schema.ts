...
export const ResourceAvgAggregateInputObjectSchema: z.ZodType<Prisma.ResourceAvgAggregateInputType> = makeSchema() as unknown as z.ZodType<Prisma.ResourceAvgAggregateInputType>;
export const ResourceAvgAggregateInputObjectZodSchema = makeSchema();
