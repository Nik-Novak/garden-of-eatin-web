...
import { ResourceOccurrenceCreateNestedManyWithoutResourceInputObjectSchema as ResourceOccurrenceCreateNestedManyWithoutResourceInputObjectSchema } from './ResourceOccurrenceCreateNestedManyWithoutResourceInput.schema';
import { ResourceSearchHitCreateNestedManyWithoutResourceInputObjectSchema as ResourceSearchHitCreateNestedManyWithoutResourceInputObjectSchema } from './ResourceSearchHitCreateNestedManyWithoutResourceInput.schema';
import { ResourceInteractionCreateNestedManyWithoutResourceInputObjectSchema as ResourceInteractionCreateNestedManyWithoutResourceInputObjectSchema } from './ResourceInteractionCreateNestedManyWithoutResourceInput.schema';
import { DeviceCreateNestedOneWithoutSubmitted_resourcesInputObjectSchema as DeviceCreateNestedOneWithoutSubmitted_resourcesInputObjectSchema } from './DeviceCreateNestedOneWithoutSubmitted_resourcesInput.schema'
...
const makeSchema = () => z.object({
  ...
  resource_occurrences: z.lazy(() => ResourceOccurrenceCreateNestedManyWithoutResourceInputObjectSchema).optional(),
  resource_search_hits: z.lazy(() => ResourceSearchHitCreateNestedManyWithoutResourceInputObjectSchema).optional(),
  resource_interactions: z.lazy(() => ResourceInteractionCreateNestedManyWithoutResourceInputObjectSchema).optional(),
  submitter: z.lazy(() => DeviceCreateNestedOneWithoutSubmitted_resourcesInputObjectSchema).optional()
}).strict();
export const ResourceCreateInputObjectSchema: z.ZodType<Prisma.ResourceCreateInput> = makeSchema() as unknown as z.ZodType<Prisma.ResourceCreateInput>;
export const ResourceCreateInputObjectZodSchema = makeSchema();
