...
export const ResourceMaxAggregateInputObjectSchema: z.ZodType<Prisma.ResourceMaxAggregateInputType> = makeSchema() as unknown as z.ZodType<Prisma.ResourceMaxAggregateInputType>;
export const ResourceMaxAggregateInputObjectZodSchema = makeSchema();
