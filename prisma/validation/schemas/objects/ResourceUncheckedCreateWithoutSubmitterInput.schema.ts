...
import { ResourceOccurrenceUncheckedCreateNestedManyWithoutResourceInputObjectSchema as ResourceOccurrenceUncheckedCreateNestedManyWithoutResourceInputObjectSchema } from './ResourceOccurrenceUncheckedCreateNestedManyWithoutResourceInput.schema';
import { ResourceSearchHitUncheckedCreateNestedManyWithoutResourceInputObjectSchema as ResourceSearchHitUncheckedCreateNestedManyWithoutResourceInputObjectSchema } from './ResourceSearchHitUncheckedCreateNestedManyWithoutResourceInput.schema';
import { ResourceInteractionUncheckedCreateNestedManyWithoutResourceInputObjectSchema as ResourceInteractionUncheckedCreateNestedManyWithoutResourceInputObjectSchema } from './ResourceInteractionUncheckedCreateNestedManyWithoutResourceInput.schema'
...
const makeSchema = () => z.object({
  ...
  resource_occurrences: z.lazy(() => ResourceOccurrenceUncheckedCreateNestedManyWithoutResourceInputObjectSchema).optional(),
  resource_search_hits: z.lazy(() => ResourceSearchHitUncheckedCreateNestedManyWithoutResourceInputObjectSchema).optional(),
  resource_interactions: z.lazy(() => ResourceInteractionUncheckedCreateNestedManyWithoutResourceInputObjectSchema).optional()
}).strict();
export const ResourceUncheckedCreateWithoutSubmitterInputObjectSchema: z.ZodType<Prisma.ResourceUncheckedCreateWithoutSubmitterInput> = makeSchema() as unknown as z.ZodType<Prisma.ResourceUncheckedCreateWithoutSubmitterInput>;
export const ResourceUncheckedCreateWithoutSubmitterInputObjectZodSchema = makeSchema();
