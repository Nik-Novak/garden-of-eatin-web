...
import { ResourceOccurrenceUpdateManyWithoutResourceNestedInputObjectSchema as ResourceOccurrenceUpdateManyWithoutResourceNestedInputObjectSchema } from './ResourceOccurrenceUpdateManyWithoutResourceNestedInput.schema';
import { ResourceSearchHitUpdateManyWithoutResourceNestedInputObjectSchema as ResourceSearchHitUpdateManyWithoutResourceNestedInputObjectSchema } from './ResourceSearchHitUpdateManyWithoutResourceNestedInput.schema';
import { ResourceInteractionUpdateManyWithoutResourceNestedInputObjectSchema as ResourceInteractionUpdateManyWithoutResourceNestedInputObjectSchema } from './ResourceInteractionUpdateManyWithoutResourceNestedInput.schema';
import { DeviceUpdateOneWithoutSubmitted_resourcesNestedInputObjectSchema as DeviceUpdateOneWithoutSubmitted_resourcesNestedInputObjectSchema } from './DeviceUpdateOneWithoutSubmitted_resourcesNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  total_weight_kg: z.union([z.number(), z.lazy(() => FloatFieldUpdateOperationsInputObjectSchema)]).optional(),
  max_weight_per_visit_kg: z.union([z.number(), z.lazy(() => FloatFieldUpdateOperationsInputObjectSchema)]).optional(),
  min_weight_per_visit_kg: z.union([z.number(), z.lazy(() => NullableFloatFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  ...
  resource_occurrences: z.lazy(() => ResourceOccurrenceUpdateManyWithoutResourceNestedInputObjectSchema).optional(),
  resource_search_hits: z.lazy(() => ResourceSearchHitUpdateManyWithoutResourceNestedInputObjectSchema).optional(),
  resource_interactions: z.lazy(() => ResourceInteractionUpdateManyWithoutResourceNestedInputObjectSchema).optional(),
  submitter: z.lazy(() => DeviceUpdateOneWithoutSubmitted_resourcesNestedInputObjectSchema).optional()
}).strict();
export const ResourceUpdateInputObjectSchema: z.ZodType<Prisma.ResourceUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.ResourceUpdateInput>;
export const ResourceUpdateInputObjectZodSchema = makeSchema();
