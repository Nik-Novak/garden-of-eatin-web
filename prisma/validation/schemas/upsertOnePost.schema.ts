...
export const PostUpsertOneSchema: z.ZodType<Prisma.PostUpsertArgs> = z.object({ select: PostSelectObjectSchema.optional(),  where: PostWhereUniqueInputObjectSchema, create: z.union([ PostCreateInputObjectSchema, PostUncheckedCreateInputObjectSchema ]), update: z.union([ PostUpdateInputObjectSchema, PostUncheckedUpdateInputObjectSchema ]) }).strict() as unknown as z.ZodType<Prisma.PostUpsertArgs>;

export const PostUpsertOneZodSchema = z.object({ select: PostSelectObjectSchema.optional(),  where: PostWhereUniqueInputObjectSchema, create: z.union([ PostCreateInputObjectSchema, PostUncheckedCreateInputObjectSchema ]), update: z.union([ PostUpdateInputObjectSchema, PostUncheckedUpdateInputObjectSchema ]) }).strict();