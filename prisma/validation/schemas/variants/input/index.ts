...
export { ResourceInputSchema } from './Resource.input';
export { ResourceOccurrenceInputSchema } from './ResourceOccurrence.input';
export { ResourceOccurrenceSearchInputSchema } from './ResourceOccurrenceSearch.input';
export { ResourceSearchHitInputSchema } from './ResourceSearchHit.input';
export { ResourceInteractionInputSchema } from './ResourceInteraction.input';
...
export { WebDeviceInputSchema } from './WebDevice.input';
