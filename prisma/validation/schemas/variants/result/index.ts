...
export { ResourceResultSchema } from './Resource.result';
export { ResourceOccurrenceResultSchema } from './ResourceOccurrence.result';
export { ResourceOccurrenceSearchResultSchema } from './ResourceOccurrenceSearch.result';
export { ResourceSearchHitResultSchema } from './ResourceSearchHit.result';
export { ResourceInteractionResultSchema } from './ResourceInteraction.result';
...
export { WebDeviceResultSchema } from './WebDevice.result';
